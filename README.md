...
| | 쿠팡 | 스마트스토어 | 카페24 | Shopify |
|---|:---:|:---:|:---:|:---:|
| **주문 수집** | ⚠️ 폴링 | ⚠️ 폴링 | ✅ 웹훅 | ✅ 웹훅 |
| **상품 등록·수정** | ✅ | ✅ | ✅ | ✅ |
| **가격 변경** | ✅ | ✅ | ✅ | ✅ |
| **재고 동기화** | ✅ | ⚠️ 전체 PUT | ⚠️ 절대값 | ✅ delta |
| **정산** | ✅ | — | ✅ | — |
| **쿠폰** | ✅ | ❌ | ✅ | ✅ |
| **키워드 관리** | ❌ | ✅ | ✅ | ✅ |
| **SEO** | ❌ | ❌ | ✅ | ✅ |
| **이미지 관리** | ✅ | ✅ | ✅ | ✅ |
| **웹훅** | ❌ | ❌ | ✅ | ✅ |
| **API 점수** | 54 / 100 | 44 / 100 | 79 / 100 | 92 / 100 |

### 판매 채널 — CSV 임포트

다운받은 파일을 `rocketsell import`에 던지면 채널을 자동 감지해 처리합니다.
...
`rocketsell trend` 커맨드로 연결된 소스들.

네이버 DataLab · 네이버 SearchAD · 무신사 · 올리브영 · 화해 · 지그재그 · 쿠팡 · Amazon · AliExpress
